...
| 시간 제한 | 1 초 |
| 메모리 제한 | 128 MB |
| 알고리즘 | 자료 구조, 그래프 이론, 그래프 탐색, 너비 우선 탐색, 최단 경로, 분리 집합, 플로이드-워셜 |
| 링크 | [백준 바로가기](https://www.acmicpc.net/problem/2610) |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 105006573 | ✅ 맞았습니다!! | 12040 KB | 92 ms | Java 8 / 수정 | 2026년 4월 14일 |
